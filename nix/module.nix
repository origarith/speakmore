# NixOS module for SpeakMore speech-to-text
#
...
# Usage in your flake:
#
#   inputs.speakmore.url = "github:OrigArith/SpeakMore";
#
#   nixosConfigurations.myhost = nixpkgs.lib.nixosSystem {
#     modules = [
#       speakmore.nixosModules.default
#       { programs.speakmore.enable = true; }
#     ];
#   };
{
  config,
...
let
  cfg = config.programs.speakmore;
in
{
  options.programs.speakmore = {
    enable = lib.mkEnableOption "SpeakMore offline speech-to-text";
