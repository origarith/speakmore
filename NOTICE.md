...
Model source details and release checklist items are tracked in [docs/model-sources.md](docs/model-sources.md).
...
The source tree also includes application icons, tray images, and audio feedback sounds. The audio feedback files match the upstream Handy assets. SpeakMore-specific icons and tray images should be treated as project-owned release assets and confirmed before public release.
