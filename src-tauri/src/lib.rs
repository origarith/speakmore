...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::add_post_process_preset,
            shortcut::update_post_process_preset,
            shortcut::duplicate_post_process_preset,
            shortcut::delete_post_process_preset,
            shortcut::set_post_process_selected_preset,
            shortcut::run_post_process_preset_preview,
            shortcut::add_post_process_prompt,
            shortcut::update_post_process_prompt,
            shortcut::delete_post_process_prompt,
            shortcut::set_post_process_selected_prompt,
            shortcut::update_custom_words,
            shortcut::update_whisper_family_settings,
            shortcut::update_qwen3_asr_family_settings,
            shortcut::reset_asr_family_settings,
            ...
            shortcut::speakmore_keys::start_speakmore_keys_recording,
            shortcut::speakmore_keys::stop_speakmore_keys_recording,
            ...
            commands::transcription::set_asr_provider,
            commands::transcription::apply_transcription_profile,
            commands::transcription::change_asr_api_key,
            commands::transcription::change_asr_model,
            commands::transcription::get_asr_provider_status,
            commands::context::capture_focused_context,
            commands::context::capture_focused_context_after_delay,
            commands::context::get_context_probe_runs,
            commands::context::clear_context_probe_runs,
            commands::history::get_history_entries,
            commands::history::get_history_entry_detail,
            commands::history::toggle_history_entry_saved,
            commands::history::get_audio_file_path,
            commands::history::delete_history_entry,
            commands::history::update_history_entry_user_edit,
            commands::history::record_history_event,
