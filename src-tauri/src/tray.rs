...
pub fn get_icon_path(theme: AppTheme, state: TrayIconState) -> &'static str {
    match (theme, state) {
        ...
        (AppTheme::Colored, TrayIconState::Idle) => "resources/speakmore.png",
...
fn version_label() -> String {
    if cfg!(debug_assertions) {
        format!("SpeakMore v{} (Dev)", env!("CARGO_PKG_VERSION"))
    } else {
        format!("SpeakMore v{}", env!("CARGO_PKG_VERSION"))
    }
}
...
mod tests {
    ...
    fn build_entry(transcription: &str, post_processed: Option<&str>) -> HistoryEntry {
        HistoryEntry {
            id: 1,
            file_name: "speakmore-1.wav".to_string(),
            timestamp: 0,
            saved: false,
            ...
            post_process_preset_version: None,
            asr_provider_id: None,
            asr_model: None,
            asr_language: None,
            user_edited_text: None,
            user_edited_at: None,
            final_text: post_processed
