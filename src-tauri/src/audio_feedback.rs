...
fn get_rodio_cpal_host() -> rodio::cpal::Host {
    #[cfg(target_os = "linux")]
    {
        rodio::cpal::host_from_id(rodio::cpal::HostId::Alsa)
            .unwrap_or_else(|_| rodio::cpal::default_host())
    }
