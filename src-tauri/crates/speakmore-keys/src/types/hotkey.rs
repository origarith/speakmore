...
impl Hotkey {
    ...
    /// # Examples
    /// ```
    /// use speakmore_keys::{Hotkey, Modifiers, Key};
    ///
    ...
    /// Format hotkey using SpeakMore-compatible key names (lowercase with full modifier names)
    ///
    ...
    pub fn to_speakmore_string(&self) -> String {
        #[cfg(target_os = "macos")]
        fn mod_names(
            mods: Modifiers,
            left: Modifiers,
