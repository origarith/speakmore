...
//!
//! `speakmore-keys` provides a simple way to register and listen for global keyboard
...
//!
//! ```no_run
//! use speakmore_keys::{HotkeyManager, Hotkey, Modifiers, Key};
//!
//! fn main() -> speakmore_keys::Result<()> {
...
//!
//! ```no_run
//! use speakmore_keys::KeyboardListener;
//!
...
//! # #[cfg(target_os = "macos")]
//! # fn main() -> speakmore_keys::Result<()> {
//! use speakmore_keys::{check_accessibility, open_accessibility_settings};
//!
