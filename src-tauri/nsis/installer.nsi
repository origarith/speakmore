; Custom NSIS template for SpeakMore with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\SpeakMore for portable
...
Function .onInit
  ...
  ; Preserve portable installs that use the current marker.
  ${If} $PortableMode <> 1
  ${AndIf} $UpdateMode = 1
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "SpeakMore Portable Mode"
    FileClose $0
