...
export const useSettings = (): UseSettingsReturn => {
  ...
  return {
    ...
    setAsrProvider: store.setAsrProvider,
    updateAsrApiKey: store.updateAsrApiKey,
    updateAsrModel: store.updateAsrModel,
    applyTranscriptionProfile: store.applyTranscriptionProfile,
  };
};
