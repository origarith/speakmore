...
const baseBackground = "var(--color-frost-control)";
const hoverBackground =
  "color-mix(in srgb, var(--color-logo-primary) 9%, var(--color-frost-control-hover))";
const focusBackground =
  "color-mix(in srgb, var(--color-logo-primary) 12%, var(--color-frost-control-hover))";
const neutralBorder = "var(--color-frost-border)";
...
const selectStyles: StylesConfig<SelectOption, false> = {
  control: (base, state) => ({
    ...
    boxShadow: state.isFocused
      ? "0 0 0 2px color-mix(in srgb, var(--color-logo-primary) 22%, transparent), inset 0 1px 0 rgba(255,255,255,0.32)"
  ...
  menu: (provided) => ({
    ...provided,
    zIndex: 30,
    backgroundColor: "var(--color-frost-surface-strong)",
    color: "var(--color-text)",
    border: "1px solid var(--color-frost-border)",
    borderRadius: 8,
    overflow: "hidden",
    backdropFilter: "blur(26px) saturate(1.35)",
    boxShadow: "0 18px 42px var(--color-frost-shadow)",
  }),
  option: (base, state) => ({
    ...base,
