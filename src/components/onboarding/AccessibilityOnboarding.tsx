...
const AccessibilityOnboarding: React.FC<AccessibilityOnboardingProps> = ({
  ...
  if (allGranted) {
    return (
      <div className="app-shell flex h-screen w-screen flex-col items-center justify-center gap-4">
  ...
  return (
    <div className="app-shell flex h-screen w-screen flex-col items-center justify-center gap-6 p-6">
      ...
      <div className="max-w-md w-full flex flex-col items-center gap-4">
        ...
        {showMicrophonePermission && (
          <div className="warm-panel w-full p-4">
