    ...
    >
      <div className="flex items-center space-x-1">
        <div className="relative" ref={dropdownRef}>
          <button
            type="button"
            className={`frost-control flex min-w-[200px] items-center justify-between rounded-md border px-2.5 py-1.5 text-start text-sm font-medium transition-all duration-150 ${
              isUpdating("selected_language")
                ? "opacity-50 cursor-not-allowed"
                : "hover:border-logo-primary/35 cursor-pointer"
            }`}
          ...
          {isOpen && !isUpdating("selected_language") && (
            <div className="frost-menu absolute left-0 right-0 top-full z-50 mt-1 max-h-60 overflow-hidden rounded-md">
              {/* Search input */}
      ...
      {isUpdating("selected_language") && (
        <div className="absolute inset-0 flex items-center justify-center rounded bg-white/40 backdrop-blur-sm dark:bg-black/20">
