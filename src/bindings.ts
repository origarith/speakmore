...
export type HistoryEntryDetail = { entry: HistoryEntry; transcription_runs: TranscriptionRun[]; post_process_runs: PostProcessRun[]; events: HistoryEvent[] }
