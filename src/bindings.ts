...
async changePostProcessReasoningEffortSetting(providerId: string, effort: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_reasoning_effort_setting", { providerId, effort }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async addPostProcessPreset(name: string, description: string, systemTemplate: string, userTemplate: string, outputKind: string) : Promise<Result<PostProcessPreset, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("add_post_process_preset", { name, description, systemTemplate, userTemplate, outputKind }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async updatePostProcessPreset(id: string, name: string, description: string, systemTemplate: string, userTemplate: string, outputKind: string, enabled: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_post_process_preset", { id, name, description, systemTemplate, userTemplate, outputKind, enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async duplicatePostProcessPreset(id: string) : Promise<Result<PostProcessPreset, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("duplicate_post_process_preset", { id }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async deletePostProcessPreset(id: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("delete_post_process_preset", { id }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async setPostProcessSelectedPreset(id: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("set_post_process_selected_preset", { id }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async runPostProcessPresetPreview(presetId: string, inputText: string) : Promise<Result<PostProcessPreviewResult, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("run_post_process_preset_preview", { presetId, inputText }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async updateWhisperFamilySettings(familySettings: WhisperFamilySettings) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_whisper_family_settings", { familySettings }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async updateQwen3AsrFamilySettings(familySettings: Qwen3AsrFamilySettings) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_qwen3_asr_family_settings", { familySettings }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async resetAsrFamilySettings(family: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("reset_asr_family_settings", { family }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async startSpeakmoreKeysRecording(bindingId: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("start_speakmore_keys_recording", { bindingId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async stopSpeakmoreKeysRecording() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("stop_speakmore_keys_recording") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async setAsrProvider(providerId: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("set_asr_provider", { providerId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async applyTranscriptionProfile(profileId: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("apply_transcription_profile", { profileId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeAsrApiKey(providerId: string, apiKey: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_asr_api_key", { providerId, apiKey }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeAsrModel(providerId: string, model: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_asr_model", { providerId, model }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async getAsrProviderStatus(providerId: string) : Promise<Result<AsrProviderStatus, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_asr_provider_status", { providerId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async captureFocusedContext(source: string) : Promise<Result<ContextProbeRun, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("capture_focused_context", { source }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async captureFocusedContextAfterDelay(source: string, delayMs: number) : Promise<Result<ContextProbeRun, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("capture_focused_context_after_delay", { source, delayMs }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async getContextProbeRuns(limit: number) : Promise<Result<ContextProbeRun[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_context_probe_runs", { limit }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async clearContextProbeRuns() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("clear_context_probe_runs") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async getHistoryEntryDetail(id: number) : Promise<Result<HistoryEntryDetail, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_history_entry_detail", { id }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async updateHistoryEntryUserEdit(id: number, text: string | null) : Promise<Result<HistoryEntry, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_history_entry_user_edit", { id, text }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async recordHistoryEvent(id: number, eventType: string, runType: string | null, runId: number | null, source: string | null, payloadJson: string | null) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("record_history_event", { id, eventType, runType, runId, source, payloadJson }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
export type AppSettings = { bindings: Partial<{ [key in string]: ShortcutBinding }>; push_to_talk: boolean; audio_feedback: boolean; audio_feedback_volume?: number; sound_theme?: SoundTheme; start_hidden?: boolean; autostart_enabled?: boolean; update_checks_enabled?: boolean; selected_model?: string; asr_provider_id?: string; asr_providers?: AsrProvider[]; asr_api_keys?: SecretMap; asr_models?: Partial<{ [key in string]: string }>; asr_family_settings?: AsrFamilySettings; transcription_profiles?: TranscriptionProfile[]; selected_transcription_profile_id?: string | null; always_on_microphone?: boolean; selected_microphone?: string | null; clamshell_microphone?: string | null; selected_output_device?: string | null; translate_to_english?: boolean; selected_language?: string; overlay_position?: OverlayPosition; debug_mode?: boolean; log_level?: LogLevel; custom_words?: string[]; model_unload_timeout?: ModelUnloadTimeout; word_correction_threshold?: number; history_limit?: number; recording_retention_period?: RecordingRetentionPeriod; paste_method?: PasteMethod; clipboard_handling?: ClipboardHandling; auto_submit?: boolean; auto_submit_key?: AutoSubmitKey; post_process_enabled?: boolean; post_process_provider_id?: string; post_process_providers?: PostProcessProvider[]; post_process_api_keys?: SecretMap; post_process_models?: Partial<{ [key in string]: string }>; post_process_reasoning_efforts?: Partial<{ [key in string]: string }>; post_process_prompts?: LLMPrompt[]; post_process_selected_prompt_id?: string | null; post_process_presets?: PostProcessPreset[]; post_process_selected_preset_id?: string | null; mute_while_recording?: boolean; append_trailing_space?: boolean; app_language?: string; experimental_enabled?: boolean; context_awareness_enabled?: boolean; lazy_stream_close?: boolean; keyboard_implementation?: KeyboardImplementation; show_tray_icon?: boolean; paste_delay_ms?: number; typing_tool?: TypingTool; external_script_path: string | null; custom_filler_words?: string[] | null; whisper_accelerator?: WhisperAcceleratorSetting; ort_accelerator?: OrtAcceleratorSetting; whisper_gpu_device?: number; extra_recording_buffer_ms?: number }
export type AsrApiKeySource = "not_required" | "settings" | "environment" | "missing"
export type AsrFamilySettings = { whisper: WhisperFamilySettings; qwen3_asr: Qwen3AsrFamilySettings }
export type AsrProvider = { id: string; label: string; base_url: string; kind: AsrProviderKind; allow_model_edit?: boolean }
export type AsrProviderKind = "built_in_local" | "aliyun_qwen_3_asr_flash" | "aliyun_qwen_3_asr_realtime"
export type AsrProviderStatus = { provider_id: string; configured: boolean; api_key_source: AsrApiKeySource; model: string; error: string | null }
export type AudioDevice = { index: string; name: string; is_default: boolean }
export type AutoSubmitKey = "enter" | "ctrl_enter" | "cmd_enter"
export type AvailableAccelerators = { whisper: string[]; ort: string[]; gpu_devices: GpuDeviceOption[] }
export type BindingResponse = { success: boolean; binding: ShortcutBinding | null; error: string | null }
export type ClipboardHandling = "dont_modify" | "copy_to_clipboard"
export type ContextProbeConfidence = "high" | "medium" | "low" | "none"
export type ContextProbeRun = { id: number; history_entry_id: number | null; captured_at: number; source: string; status: ContextProbeStatus; confidence: ContextProbeConfidence; latency_ms: number; app_name: string | null; bundle_id: string | null; pid: number | null; window_title: string | null; element_role: string | null; element_subrole: string | null; is_secure: boolean; value_text: string | null; before_text: string | null; selected_text: string | null; after_text: string | null; selected_location_utf16: number | null; selected_length_utf16: number | null; number_of_characters: number | null; available_attributes_json: string | null; failure_reason: string | null; truncated: boolean }
export type ContextProbeStatus = "success" | "permission_denied" | "no_focused_element" | "not_text_input" | "blocked_secure_field" | "attribute_unavailable" | "unsupported_platform" | "error"
...
export type HistoryEntry = { id: number; file_name: string; timestamp: number; saved: boolean; title: string; transcription_text: string; post_processed_text: string | null; post_process_prompt: string | null; post_process_requested: boolean; post_process_preset_id: string | null; post_process_preset_version: number | null; asr_provider_id: string | null; asr_model: string | null; asr_language: string | null; user_edited_text: string | null; user_edited_at: number | null; final_text: string; latest_transcription_run_id: number | null; latest_post_process_run_id: number | null; status: string }
export type HistoryEntryDetail = { entry: HistoryEntry; transcription_runs: TranscriptionRun[]; post_process_runs: PostProcessRun[]; events: HistoryEvent[]; focused_context: ContextProbeRun | null }
export type HistoryEvent = { id: number; history_entry_id: number; run_type: string | null; run_id: number | null; event_type: string; source: string; payload_json: string | null; created_at: number }
...
export type KeyboardImplementation = "tauri" | "speakmore_keys"
export type LLMPrompt = { id: string; name: string; prompt: string }
export type LogLevel = "trace" | "debug" | "info" | "warn" | "error"
export type ModelInfo = { id: string; name: string; description: string; filename: string; url: string | null; sha256: string | null; size_mb: number; is_downloaded: boolean; is_downloading: boolean; partial_size: number; is_directory: boolean; engine_type: EngineType; source: ModelSource; accuracy_score: number; speed_score: number; supports_translation: boolean; is_recommended: boolean; supported_languages: string[]; supports_language_selection: boolean; is_custom: boolean }
export type ModelLoadStatus = { is_loaded: boolean; current_model: string | null }
export type ModelSource = "Handy" | "SpeakMore" | "Custom"
...
export type PostProcessApiKind = "open_ai_compatible" | "apple_intelligence"
export type PostProcessPreset = { id: string; name: string; description?: string; prompt_template: string; system_template?: string | null; user_template?: string | null; output_kind?: string; version?: number; is_builtin?: boolean; enabled?: boolean; examples?: PostProcessPresetExample[] }
export type PostProcessPresetExample = { input: string; output: string }
export type PostProcessPreviewResult = { preset_id: string; preset_version: number; provider_id: string | null; model: string | null; status: string; output_text: string | null; latency_ms: number; error_summary: string | null }
export type PostProcessProvider = { id: string; label: string; base_url: string; allow_base_url_edit?: boolean; models_endpoint?: string | null; supports_structured_output?: boolean; api_kind?: PostProcessApiKind; structured_output_mode?: PostProcessStructuredOutputMode; reasoning_control?: PostProcessReasoningControl; model_suggestions?: string[]; deprecated_model_suggestions?: string[] }
export type PostProcessReasoningControl = "none" | "open_ai_reasoning_effort" | "open_router_reasoning" | "deep_seek_thinking"
export type PostProcessRun = { id: number; history_entry_id: number; preset_id: string | null; preset_version: number | null; provider_id: string | null; model: string | null; status: string; input_text: string | null; output_text: string | null; prompt_template_snapshot: string | null; latency_ms: number; error_summary: string | null; created_at: number }
export type PostProcessStructuredOutputMode = "none" | "open_ai_json_schema" | "json_object"
export type Qwen3AsrFamilySettings = { language: string; custom_vocabulary: string[]; max_new_tokens: number; max_total_len: number }
export type RecordingRetentionPeriod = "never" | "preserve_limit" | "days_3" | "weeks_2" | "months_3"
export type SecretMap = Partial<{ [key in string]: string }>
export type ShortcutBinding = { id: string; name: string; description: string; default_binding: string; current_binding: string }
export type SoundTheme = "marimba" | "pop" | "custom"
export type TranscriptionProfile = { id: string; name: string; description: string; asr_provider_id: string; asr_model: string | null; language: string; translate_to_english: boolean; post_process_enabled: boolean; post_process_preset_id: string | null; is_builtin?: boolean }
export type TranscriptionRun = { id: number; history_entry_id: number; provider_id: string | null; model: string | null; language: string | null; status: string; transcript_text: string; latency_ms: number; error_summary: string | null; created_at: number }
export type TypingTool = "auto" | "wtype" | "kwtype" | "dotool" | "ydotool" | "xdotool"
export type WhisperAcceleratorSetting = "auto" | "cpu" | "gpu"
export type WhisperFamilySettings = { language: string; translate_to_english: boolean; custom_vocabulary: string[] }
